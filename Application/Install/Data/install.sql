...
INSERT INTO `wp_plugin` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`, `cate_id`, `is_show`) VALUES ('127', 'ImageManager', '图片管理', '图片管理，快速选择已上传图片到封面', '1', '{\"page_size\":\"20\",\"delete_switch\":\"1\",\"delete_mode\":\"0\"}', 'wzh', '0.1', '1462355266', '0', NULL, '1');
...
INSERT INTO `wp_model` (`name`,`title`,`extend`,`relation`,`need_pk`,`field_sort`,`field_group`,`attribute_list`,`template_list`,`template_add`,`template_edit`,`list_grid`,`list_row`,`search_key`,`search_list`,`create_time`,`update_time`,`status`,`engine_type`,`addon`) VALUES ('shop_vote_log','选手投票记录','0','','1','["vote_id","option_id","uid"]','1:基础','','','','','vote_id:25%用户头像\r\nuid:25%用户\r\noption_id:25%投票选项\r\nctime|time_format:25%投票时间','10','truename:请输入用户名字','','1443150057','1447749584','1','MyISAM','Vote');
