          ...
          <table cellspacing="0" class="message_list">
            ...
            <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td class="user">
                    ...
                    <?php else: ?>
                    	<img width="50" src="/weiphp3/Public/Home/images/default.png"/><?php endif; ?>
                	<div class="u_info">
                        ...
                        <p class="msg">
                        	...
                        	<?php elseif($vo['Content']['msg_type'] == 'voice'): ?>
	                            ...
	                            <img class="icon_sound" src="/weiphp3/Public/Home/images/icon_sound.png"/>
                ...
                <td valign="top">
                <a href="<?php echo U('person',array('openid'=>$vo[openid]));?>">会话详情</a>
                </td>
